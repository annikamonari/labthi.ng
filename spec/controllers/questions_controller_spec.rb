...
describe QuestionsController do
  ...
  let(:valid_session) { {id: FactoryGirl.create(:idea).id} }
  ...
  describe "GET new" do
    it "assigns a new question as @question" do
      get :new, {:id => valid_attributes[:idea].id}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Question" do
        expect {
          post :create, :question => valid_attributes, :id => valid_attributes[:idea].id
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved question as @question" do
        ...
        post :create, {:question => { "title" => "invalid value" }, :id => valid_attributes[:idea].id}, valid_session
        assigns(:question).should be_a_new(Question)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested question" do
        ...
        Question.any_instance.should_receive(:update).with({ "title" => "MyText" })
