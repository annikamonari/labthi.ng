  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created solution" do
        redirect_path = idea_aspect_path(idea_id:@solution.idea.id, id: @solution.aspect.id)
        post :create,
          {:solution => valid_attributes,
          aspect_id: @solution.aspect.id,
          idea_id: @solution.idea.id}
